...
function osc_init()
    ...
    ne.softrepeat = true
    ne.content = tethys_icon_skipback
    ...
    ne.softrepeat = true
    ne.content = tethys_icon_skipfrwd
    ne.eventresponder["mbtn_left_down"] =
